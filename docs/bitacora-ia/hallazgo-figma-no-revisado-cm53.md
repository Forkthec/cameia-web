...
| Nodos citados en `SPEC.md` §9 para el logo del `AppShell` (`121:184`, `191:500`) | El nodo real del logo en este frame es `191:501` (dentro de `nav-header` `191:499`) — ninguno de los dos números citados corresponde a nada visible en el archivo |
