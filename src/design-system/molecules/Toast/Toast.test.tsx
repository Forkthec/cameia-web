/**
 * Comportamiento observable de `Toast`, no implementación: que
 * `variant="error"` usa `role="alert"`, y que el botón de cerrar solo
 * existe (y dispara `onDismiss`) cuando se recibe ese callback.
 */
